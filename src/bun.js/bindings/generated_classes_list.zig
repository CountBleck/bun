pub const Classes = struct {
    ...
    pub const CompressionStreamEncoder = webcore.compression.CompressionStreamEncoder;
    pub const DecompressionStreamDecoder = webcore.compression.DecompressionStreamDecoder;
